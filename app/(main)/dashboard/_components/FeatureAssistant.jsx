    ...
    return (
        <div>
            <div className='flex justify-between items-center'>
               ...
               <ProfileDialog>
                 <Button className="bg-orange-600 text-white shadow-lg shadow-orange-900/40 hover:bg-orange-600 transition-color hover:shadow-orange-900/60 transition-shadow">
                    Profile
                </Button>
               </ProfileDialog>
